...
public class GuiOptionsPageBetterThanRain implements ClientStartEntrypoint {
    ...
    public static final OptionsPage BetterThanRainPage = OptionsPages.register(new OptionsPage("betterthanrain.options.title", Items.BUCKET_WATER.getDefaultStack())
            .withComponent(
                    new OptionsCategory("betterthanrain.options.category")
            ...
            .withComponent(new OptionsCategory("betterthanrain.options.materials")
                    ...
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.metalMuffledVolume")))
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.glassRainVolume")))
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.glassMuffledVolume")))
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.fabricRainVolume")))
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.fabricMuffledVolume")))
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.stoneRainVolume")))
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.stoneMuffledVolume")))
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.woodRainVolume")))
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.woodMuffledVolume")))
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.plasticRainVolume")))
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.plasticMuffledVolume")))
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.lavaRainVolume")))
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.lavaMuffledVolume")))
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.foliageRainVolume")))
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.foliageMuffledVolume")))
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.waterRainVolume")))
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.waterMuffledVolume")))
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.noteblockRainVolume")))
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.noteblockMuffledVolume"))))
            .withComponent(new OptionsCategory("betterthanrain.options.thunder")
                    .withComponent(new FloatOptionComponent(getFloatOption("betterthanrain.thunderVolume"))))
